...
| `kanban` | Work with GitHub Projects, Milestones, and issue trackers. Use when you need to update delivery state, triage issues, create tickets, organize milestones, or trace planned work. |
