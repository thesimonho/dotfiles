...
The repository is initialized without a remote or GitHub Project context. Planning coverage therefore exercises only the unchanged local-planning branch, including its `docs/plans/` artifact rules; it deliberately does not test GitHub discovery, issue creation, Project updates, or ticketization.
