...
return {
  {
    ...
    opts = {
      ...
      cursor_priority = 100,
      diagnostics_error_symbol = constants.icons.diagnostics.Error,
      diagnostics_warn_symbol = constants.icons.diagnostics.Warn,
      diagnostics_info_symbol = constants.icons.diagnostics.Info,
      diagnostics_hint_symbol = constants.icons.diagnostics.Hint,
