...
| `score_compute_selection()` | `compute_selection_scoring.py` | Matches normalized model-selection evidence against the best provider-specific acceptable set and returns a percentage and rationale |
