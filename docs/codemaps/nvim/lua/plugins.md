...
| --- | --- |
| `AI.lua` | Embedded agent terminals and selection forwarding |
| `tabby.lua` | Native multiline inline completion, Tabby analytics, and session-scoped container lifecycle |
